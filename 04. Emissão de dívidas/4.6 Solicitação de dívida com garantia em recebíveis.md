...
O objeto Collateral_Management é um dos objetos aninhados que compõem o Objeto Contrato exemplificado acima. Collateral_Management é composto por 2 campos de dados, referentes a como será feita a gestão de garantia:

| Campo | Descrição | Exemplo | 
|---|---|---|
| **`collateral_percentage`** | Percentual mínimo de garantias a alcançar | 0.2 |
| **`collateral_management_type`** | Tipo de contrato da gestão de garantia | absolute |
...
Todo o restante da solicitação de dívida, respostas e webhooks seguem o mesmo fluxo da [Emissão com Recebíveis](?file=446)