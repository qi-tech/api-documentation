...
| **`maximum_value`** | Valor máximo que será utilizado | 2000 |
| **`maximum_daily_value`** | Valor máximo que será utilizado por dia | 200 |
| **`minimum_date`** | Data mínima para começar à utilizar os recebiveis | 2021-06-28 |
| **`contract_payment_type`** | Tipo de pagamento para o contrato (partial_payment, total_payment, monthly_payment) | partial_payment |
