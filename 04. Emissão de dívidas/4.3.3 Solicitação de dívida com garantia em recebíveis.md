...
| **`maximum_value`** | Valor maximo a ser utilizado | 2000 |
| **`maximum_daily_value`** | Valor maximo a ser utilizado por dia | 200 |
| **`minimum_date`** | Data minima para começar à urilizar os recebiveis | 2021-06-28 |
| **`contract_payment_type`** | Tipo de pagamento para o contrato (partial_payment, total_payment, monthly_payment) | monthly_payment |
