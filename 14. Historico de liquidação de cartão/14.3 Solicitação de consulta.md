...
| **`authenticity.geolocation.lat`** | Latitude do objeto de Geolocalização do signatário | 38.8951 |
| **`authenticity.geolocation.long`** | Longitude do objeto de Geolocalização do signatário | -77.0364 |
