...
| **`phone`** *(obrigatório)* | Telefone da pessoa | **[Objeto Telefone](?4441#objeto-telefone)** |
| **`address`** *(obrigatório)* | Endereço da pessoa | **[Objeto Endereço](?4441#objeto-endereco)** |
...
| Campo | Descrição | Exemplo |
|---|---|---|
| **`address`** *(obrigatório)* | Endereço da empresa | **[Objeto Endereço](?4441#objeto-endereco)** (descrito abaixo) |
...
| **`phone`** *(obrigatório)* | Telefone da empresa | **[Objeto Telefone](?4441#objeto-telefone)** (descrito abaixo) |
