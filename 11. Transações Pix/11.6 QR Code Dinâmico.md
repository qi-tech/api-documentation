...
|---------------------------------------------|----------------------------------------------------------------------|----------------------------------------------------|
| **`amount`** _(opcional)_                   | Valor do QR Code antes do cálculo de descontos ou juros e multas.    | 100                                                |
| **`occurrence_type`** _(opcional)_          | Campo do tipo enumerador                                             | **[Enumerador de Ocorrência](#objeto-ocorrencia)** |
| **`qr_code_type`** _(opcional)_             | Tipo do QR Code dinâmico                                             | "dynamic_instant"                                  |
| **`pix_key`** _(opcional)_                  | Chave Pix que representa a conta de destino da transação             | "031fa390-4345-4a68-a5af-4caf85f955a2"             |
...
Para decodificar um QR Code acesse a documentação: [Decodificando um QR Code](?file=11114).
