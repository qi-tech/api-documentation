...
- **disbursement_bank_account**: informações bancárias para o desenbolso ([Objeto Conta Bancária](#objeto-conta-bancaria))
...
| **`company_statute`** *(obrigatório)*| **DOCUMENT_KEY** PDF do estatuto da empresa ([enviado previamente](?file=331))| "ff26d5cb-b4e4-477f-9341-645d3e1d65de" |
...
| **`spouse`** *(obrigatório)* | [Objeto PF](#objeto-PF) do esposo/esposa da pessoa (obrigatório apenas quando "compulsory_separation_of_goods" for "total_communion_of_goods", "partial_communion_of_goods", "final_participation_of_acquisitions" ou "compulsory_separation_of_goods") | **[Objeto PF](#objeto-PF)** |
...
| **`document_identification`** *(obrigatório)* | **DOCUMENT_KEY** PDF do documento de identificação da pessoa com foto (RG ou CNH) ([enviado previamente](?file=331)) | "3c24579b-9810-4fa6-9b08-fe67d237160a" |
