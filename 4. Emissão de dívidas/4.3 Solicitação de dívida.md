...
| **`wedding_certificate`** *(obrigatório)* | **DOCUMENT_KEY** PDF do certificado de casamento da pessoa ([enviado previamente](?file=331)). No caso de marital_status ser "single", o valor deste campo deve ser `null`  | "56ab7849-4d90-490b-b539-96ac3c5a619b" |
