...
A princípio ode parecer muita informação, no entanto, como veremos abaixo podemos obervar que esse objeto é composto por 4 partes.
...
| **`company_document_numbe`r** *(obrigatório)*| CNPJ (em texto, apenas números, deve conter 14 caracteres)| "30620610000159" |
