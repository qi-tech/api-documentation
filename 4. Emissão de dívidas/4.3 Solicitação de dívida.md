...
- <span style="color:#4FCCED">guarantors</span>: garantidores da operação (que pode ser uma lista de Objeto PF e/ou Objeto PJ e não é um campo obrigatório)
- <span style="color:#FF4080">disbursement_bank_account</span>: informações bancárias para o desenbolso
