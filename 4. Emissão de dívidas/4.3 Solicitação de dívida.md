...
Uma emissão de dívida deve conter as informações bancárias para desembolso, uma conta do tomador. Este objeto deve ser uma lista com somente uma conta (a funcionalidade de desembolso em mais de uma conta será implementada em uma atualização futura). O Objeto Conta Bancária deve conter:
