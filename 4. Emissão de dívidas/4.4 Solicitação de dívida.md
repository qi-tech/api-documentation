...
- **additional_data**: dados adicionais da operação ([Objeto Adicional](#objeto-adicional))
...
| **document_number** | CPF ou CNPJ do dono da conta para desembolso (obrigatório caso haja mais de uma conta para desembolso) | "94632180173" |
| **name** | Nome do dono da conta para desembolso (obrigatório caso haja mais de uma conta para desembolso) | "Pedro Felipe Henrique Alves" |
...
O objeto adicional serve para o envio de dados adicionais que podem ou não serem necessários ao cliente, por exemplo, no
caso de uma solicitação na qual o cliente já possua os contratos assinados. Para este caso, o Objeto Adicional é composto
de:
