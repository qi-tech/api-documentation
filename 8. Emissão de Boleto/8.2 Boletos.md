...
```json
{
  "occurrence_stats": {
    "bank_slip_edit": true,
    "bankruptcy_protest_request": true,
    "cancel_rebate": true,
    "extension": true,
    "notary_office_entry": true,
    "notary_office_exit": true,
    "notary_office_payment": true,
    "payment": true,
    "protest_cancel_and_write_off_request": true,
    "protest_cancel_request": true,
    "protest_request": true,
    "rebate": true,
    "registration": true,
    "write_off": true
  },
  ...
  "semantic_errors": [
    {
      "occurrence_sequence": [
        {
          "bank_reason_code": "24",
          "bank_reason_name": "Código do banco inválido",
          "bank_occurrence_code": "2",
          "created_at": "2020-04-17T21:41:09",
          "occurrence_type": "registration",
          "occurrence_feedback": "confirmed",
          "registration_institution": "bradesco",
          "reason": "string"
        }
      ]
    }
      ...
      "registration_institution_occurrence_event": [
        {
          ...
          "cnab_file_occurrence_order": 0,
          "created_at": "2020-04-17T21:41:09",
          "new_status": "waiting_submission",
          "old_status": "waiting_submission"
        }
      ],
      "registration_institution_occurrence_status": "waiting_submission",
