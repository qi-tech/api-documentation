...
Como mostrado na [introdução do capítulo](?221) tanto as chamadas possuem tanto sua request quanto sua response encodadas, e em ambos casos o resultado de qualquer chamada é semelhante e pode ser quebrado em:
