...
Para tanto deverá ser utilizado o campo informado no retorna da transação `transaction_key`, seguindo as orientações deste [documento](6.5 Comprovante de Transferência.md)

Caso seja uma transação agendada deverá ser utilizado o campo `schedule_key`
