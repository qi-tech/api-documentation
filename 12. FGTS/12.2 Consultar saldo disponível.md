...
Como citado na introdução, a primeira parte da integração com a QI e consequentemente criação da operação consiste na consulta do saldo disponível do trabalhador. Isso permite que o cliente visualize a quantia que será disponibilizado para recebimento, em cada ano, pelo saque-aniversário FGTS.
